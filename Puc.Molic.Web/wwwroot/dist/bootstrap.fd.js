! function (e) {
    ...
    e.FileDialog = function (a) {
        var o = e.extend(e.FileDialog.defaults, a),
            t = e(["<div class='modal fade'>", "    <div class='modal-dialog'>", "        <div class='modal-content'>",
                ...
                "                <input type='submit' class='btn btn-primary bfd-ok' value=" + o.ok_button+">",
                //"                </button>",
        ...
        drag_message: "Arquivo Molic XML",
        dropheight: 300,
